...
public class RobotContainer {
        ...
        PickLimelightMode setLimelightModeOn = new PickLimelightMode(visionSub,
        ...
        RunCommand driveSticks = new RunCommand(
                        () -> vroomVroomSub.greenLight(midStick.getRawAxis(0), (-1) * leftStick.getRawAxis(1)),
                        vroomVroomSub);
        ...
        Command rightBallRightMacFourBall = (new ResetWheels(vroomVroomSub))
                        ...
                        .andThen((new AutoForwards(vroomVroomSub, 73))
                                        .alongWith(new PickLimelightMode(visionSub,
        ...
        Command leftBallLeftMacFourBall = (new ResetWheels(vroomVroomSub))
                        ...
                        .andThen(new AutoBackwards(vroomVroomSub, 15))
                        .andThen(new ResetWheels(vroomVroomSub))
                        .andThen(new AutoSpinRight(vroomVroomSub, 120))
                        .andThen(new ResetWheels(vroomVroomSub))
                        .andThen(new AutoForwards(vroomVroomSub, 100));
