...
public class RobotContainer {
  ...
  // commands
  AngledHookMove angledHookMove = new AngledHookMove(angledHooks, () -> middleJoystick.getRawAxis(Constants.UP_DOWN_AXIS));
  ...
  Drive drive = new Drive(driveTrain, () -> leftJoystick.getRawAxis(Constants.UP_DOWN_AXIS), () -> middleJoystick.getRawAxis(Constants.LEFT_RIGHT_AXIS));
  ...
  VerticalHooksMove verticalHooksMove = new VerticalHooksMove(verticalHooks, () -> rightJoystick.getRawAxis(Constants.UP_DOWN_AXIS));
