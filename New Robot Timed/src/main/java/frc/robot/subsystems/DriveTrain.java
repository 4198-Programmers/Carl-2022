...
public class DriveTrain extends SubsystemBase{
    ...
    DifferentialDrive allDrive = new DifferentialDrive(new MotorControllerGroup(frontRightMotor, backRightMotor), new MotorControllerGroup(frontLeftMotor, backLeftMotor));
