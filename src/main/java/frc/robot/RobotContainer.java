...
import frc.robot.commands.AutoCommandTurn;
...
public class RobotContainer {
  ...
  private DriveCommand drive = new DriveCommand(leftJoystick, middlejoystick, driveTrain);
  ...
  private final AutoCommandTurn m_autoCommandTurn = new AutoCommandTurn(driveTrain);
