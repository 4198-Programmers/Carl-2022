...
public class RobotContainer {
    ...
    Command midBallRightMacFourBall = (new ResetWheels(vroomVroomSub))
            ...
            .andThen(new ResetWheels(vroomVroomSub))
            .andThen(new AutoBackwards(vroomVroomSub, 15))
            .andThen(new ResetWheels(vroomVroomSub))
            .andThen(new AutoSpinLeft(vroomVroomSub, 90))
            .andThen(new ResetWheels(vroomVroomSub))
            .andThen(new AutoForwards(vroomVroomSub, 80));

    Command rightBallRightMacFourBall = (new ResetWheels(vroomVroomSub))
            .andThen((new SetIntakeSpeedIn(intakeSub))
                    .alongWith(new AutoBackwards(vroomVroomSub, 2)))
            .andThen(new ResetWheels(vroomVroomSub))
            .andThen(new AutoForwards(vroomVroomSub, 45))
            ...
            .andThen(new IntakeStop(intakeSub))
            .andThen(new ResetWheels(vroomVroomSub))
            .andThen(new Spin(vroomVroomSub, 145))
            .andThen(new Targeting(vroomVroomSub, visionSub))
            .andThen(new ResetWheels(vroomVroomSub))
            .andThen((new AutoForwards(vroomVroomSub, 73))
                    .alongWith(new PickLimelightMode(visionSub, Constants.LIMELIGHT_OFF_PIPELINE_MODE)))
            .andThen(new SetFlySpeed(flyAndSensorsSub, visionSub, true, 750, midStick))
            .andThen(new TimedInternalMoveIn(tunnelSub, 700))
            .andThen(new TimedInternalMoveOut(tunnelSub, 250))
            .andThen(new SetFlySpeed(flyAndSensorsSub, visionSub, true, 750, midStick))
    ...
    Command leftBallLeftMacFourBall = (new ResetWheels(vroomVroomSub))
            .andThen((new SetIntakeSpeedIn(intakeSub))
                    .alongWith(new AutoBackwards(vroomVroomSub, 2)))
            .andThen(new ResetWheels(vroomVroomSub))
            .andThen(new AutoForwards(vroomVroomSub, 45))
            ...
            .andThen(new WaitCommand(1))
            .andThen(new SensorTummyStopAll(flyAndSensorsSub, tunnelSub, intakeSub))
            .andThen(new ResetWheels(vroomVroomSub)).andThen(new AutoBackwards(vroomVroomSub, 15))
            .andThen(new ResetWheels(vroomVroomSub)).andThen(new AutoSpinRight(vroomVroomSub, 120))
            .andThen(new ResetWheels(vroomVroomSub)).andThen(new AutoForwards(vroomVroomSub, 100));

    Command rightLeftBallShoot = (new ResetWheels(vroomVroomSub))
            .andThen((new SetIntakeSpeedIn(intakeSub))
                    .alongWith(new AutoBackwards(vroomVroomSub, 2)))
            .andThen(new ResetWheels(vroomVroomSub))
            .andThen(new AutoForwards(vroomVroomSub, 45))
    ...
    private void begin() {
        ...
        m_chooser.setDefaultOption("Two Ball Auto (M)", taxiTwoBallShootMidBall);
        // m_chooser.addOption("Four Ball", taxiFourBall);
        m_chooser.addOption("Two Ball Auto (R/L)", rightLeftBallShoot);
        m_chooser.addOption("Hangar Ball", leftBallLeftMacFourBall);
        m_chooser.addOption("Player Ball", midBallRightMacFourBall);
        m_chooser.addOption("Wall Ball", rightBallRightMacFourBall);
