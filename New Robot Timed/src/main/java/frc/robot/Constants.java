...
//Joystick Port IDs
    public static final byte LEFT_STICK_PORT_ID = 0;
    public static final byte MID_STICK_PORT_ID =1;
    public static final byte RIGHT_STICK_PORT_ID = 2;
//Drive Motor IDs
    public static final byte FRONT_RIGHT_MOTOR_PORT_ID = 4;
...
//Wanted Heights
    ...
    public static final double VERT_HOOK_DANCE_HEIGHT = 0;
    public static final double ANGLED_HOOK_DANCE_ANGLE = 0;
}
